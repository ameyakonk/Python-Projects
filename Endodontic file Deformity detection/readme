Introduction: Endodontic file is used for Root Canal operations. While performing Root Canal procedure, the doctor may have to continuously keep on changing files of different sizes, 
              in order to perform accurate Root canal operations. The Endodontic file gets deformed if excessive force is put on it. This results into the breakage of file.
